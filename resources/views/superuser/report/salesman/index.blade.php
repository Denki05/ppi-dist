      ...
      <div class="col-md-9">
        <div class="block">
          <div class="block-content">
            ...
            <div class="form-group row">
              <label class="col-md-2 col-form-label text-left" for="status">Salesman :</label>
              <div class="col-md-4">
                <select class="js-select2 form-control" id="salesman" name="salesman[]" data-placeholder="Select Salesman" multiple="multiple">
        ...
        buttons: [
          {
            ...
            titleAttr: 'Excel',
            title: function() {
                var title = 'Salesman Report - ' + new Date().toLocaleDateString();
                return title;
            },
            messageTop: function() {
                var messageTop = 'Periode: ' + start_date + ' to ' + end_date;
                return messageTop;
            },
            footer: true,
          },
