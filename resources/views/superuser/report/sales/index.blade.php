  ...
  <script type="text/javascript">
    ...
    $(function(){
      ...
      $(document).on('click','.btn-print',function(){
          ...
          window.open('{{route('superuser.report.sales.print')}}'+'?period_from='+period_from+'&period_to='+period_to+'&customer_id='+customer_id+'&sales_senior_id='+sales_senior_id+'&sales_id='+sales_id,'_blank');
      })
