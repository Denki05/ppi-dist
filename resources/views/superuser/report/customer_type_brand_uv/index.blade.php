    ...
    <div class="block">
        ...
        <div class="block-content block-content-full">
            <div class="btn-toolbar" role="toolbar">
                ...
                <div class="btn-group mr-2">
                    <button type="button" class="btn btn-danger" onclick="saveConfirmation('{{ route('superuser.report.customer_type_brand_uv.removeDt') }}')">
                        <i class="fa fa-trash"></i> Remove Data UV
                    </button>
                </div>
                <div class="btn-group mr-2">
                    <button type="button" class="btn btn-success" onclick="submitForm('print')" targe="_blank">
                        <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export PDF UV
                    </button>
                </div>
            </div>
            <br>
...
<script>
  ...
  function submitForm(actionType) {
      let form = $('#reportForm');
      if (actionType === 'print') {
          form.attr('action', "{{ route('superuser.report.customer_type_brand_uv.print_report') }}");
      } else {
