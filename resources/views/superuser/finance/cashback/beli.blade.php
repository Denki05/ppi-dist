                  ...
                  <tbody>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="text-align:center"></th> <!-- Placeholder for the total -->
                        </tr>
                    </tfoot>
                </table>
              </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#filter-button').click(function() {
            ...
            window.location.href = "{{ route('superuser.finance.cashback.pageReportBeli') }}?" + query;
        });
    });
</script>
@endpush
