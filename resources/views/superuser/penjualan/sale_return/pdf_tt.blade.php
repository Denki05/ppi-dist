  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right">{{ number_format($getRetur->cost->sum('purchase_total_idr'), 0, ',', '.') }}</td>
      </tr>
      <tr>
        <td colspan="2" class="text-right"><strong>Total :</strong></td>
        <td class="text-right"><strong>{{ number_format( $getDo->do_detail_cost->purchase_total_idr - $getRetur->cost->sum('purchase_total_idr'), 0, ',', '.') }}</strong></td>
      </tr>
    </tbody>
  </table>
