  ...
  <div class="block-content">
    ...
    <div class="row pt-30 mb-15">
      ...
      <div class="col-md-6 text-right">
        <a class="btn btn-primary btn-print" href="{{ route('superuser.penjualan.sales_order.print_proforma', [$result->id]) }}" role="button"><i class="fa fa-print" aria-hidden="true"></i> Print Proforma</a>
