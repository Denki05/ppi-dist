  ...
  <body>
    <div class="row-float" style="margin-bottom: 20px !important;">
      ...
      <div class="column-float" style="width: 55%;margin-top: 10px;font-size: 15px;">
        <h3 style="text-align: right;margin: 0;padding: 0;margin-bottom: 5 !important;padding-bottom: 0 !important;">Delivery Order Mutation</h3>
    ...
    <div style="margin-bottom: 15px;font-size: 13px;">
      <table style="width: 100%;">
        <tbody>
          ...
          <tr>
            <td style="width: 20%;"><b>Origin Warehouse</b></td>
            <td style="width: 80%;">: {{$result->origin_warehouse->name ?? ''}}</td>
          </tr>
          <tr>
            <td style="width: 20%;"><b>Destination Warehouse</b></td>
            <td style="width: 80%;">: {{$result->destination_warehouse->name ?? ''}}</td>
          </tr>
          <tr>
      ...
      <table style="width: 100%;" class="table-data">
        <thead>
          <tr>
            ...
            <th style="padding: 6px 2px !important;">Note</th>
          </tr>
        </thead>
        <tbody>
          ...
          @foreach($result->do_mutation_item as $index => $row)
            <tr>
              ...
              <td style="padding: 5px 2px;">{{$row->packaging_txt()->scalar ?? ''}}</td>
              ...
              <td style="padding: 5px 2px;">{{$row->note ?? ''}}</td>
            </tr>
          @endforeach
        </tbody>
      </table>
