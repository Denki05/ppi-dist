...
<form class="ajax" data-action="{{ route('superuser.penjualan.sales_order_kontrak.update', $kontrak->id) }}" data-type="POST" enctype="multipart/form-data">
                ...
                <div class="block-content">
                    <div class="form-group row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="code" name="code" onkeyup="nospaces(this)" value="{{ $kontrak->code }}">
                        </div>
                        <div class="col">
                            <label class="col-form-label text-right" for="durasi_kontrak">Durasi <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" name="durasi_kontrak" value="{{ $kontrak->contract_range }}">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="block-content">
            <table id="datatables" class="table table-striped">
                ...
                <tbody>
                    ...
                    <td style="width: auto;">
                        <input type="number" name="price" id="price" class="form-control" style="text-align: center;" value="{{ $item->price }}">
                    </td>
                    <td style="width: auto;">
                        <input type="number" name="qty" id="qty" class="form-control" style="text-align: center;" value="{{ $item->qty }}">
                    </td>
                    <td style="width: auto;">
                        <input type="number" name="disc_usd" id="disc_usd" class="form-control" style="text-align: center;" value="{{ $item->disc_usd }}">
                    </td>
                </tbody>
            </table>
