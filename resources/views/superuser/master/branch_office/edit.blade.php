...
<nav class="breadcrumb bg-white push">
  ...
  <a class="breadcrumb-item" href="{{ route('superuser.master.branch_office.show', $branch_office->id) }}">{{ $branch_office->id }}</a>
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.master.branch_office.update', $branch_office) }}" data-type="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" id="code" name="code" onkeyup="nospaces(this)" value="{{ $branch_office->code }}" disabled>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row pt-30">
        <div class="col-md-6">
          <a href="{{ route('superuser.master.branch_office.show', $branch_office->id) }}">
