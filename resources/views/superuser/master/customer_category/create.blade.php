...
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Create Customer Category</h3>
  </div>
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.master.customer_category.store') }}" data-type="POST" enctype="multipart/form-data">
