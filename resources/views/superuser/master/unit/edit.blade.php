...
<nav class="breadcrumb bg-white push">
  ...
  <a class="breadcrumb-item" href="{{ route('superuser.master.unit.show', $unit->id) }}">{{ $unit->id }}</a>
...
<div class="block">
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.master.unit.update', $unit) }}" data-type="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="abbreviation">Abbreviation <span class="text-danger">*</span></label>
        <div class="col-md-7">
      ...
      <div class="form-group row pt-30">
        <div class="col-md-6">
          <a href="{{ route('superuser.master.unit.show', $unit->id) }}">
