  ...
  <div class="col-md-6">
    <div class="block">
      <div class="block-content block-content-full">
        <form action="{{ route('superuser.master.customer.contact.add', $customer->id) }}" method="POST">
          @csrf
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ route('superuser.master.customer.contact.remove', [$customer->id, $contact->pivot->id]) }}">
