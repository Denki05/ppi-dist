  ...
  <div class="col-md-6">
    <div class="block">
      <div class="block-content block-content-full">
        <form action="{{ route('superuser.master.product_category.type.add', $product_category->id) }}" method="POST">
          @csrf
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ route('superuser.master.product_category.type.remove', [$product_category->id, $type->pivot->id]) }}">
