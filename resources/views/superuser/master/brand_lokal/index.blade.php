...
<nav class="breadcrumb bg-white push">
  ...
  <span class="breadcrumb-item active">Brand PPI</span>
</nav>
@if($errors->any())
...
<div class="block">
  <div class="block-content">
    <a href="{{ route('superuser.master.brand_lokal.create') }}">
...
$(document).ready(function() {
  let datatableUrl = '{{ route('superuser.master.brand_lokal.json') }}';
