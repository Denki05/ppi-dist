  ...
  <div class="block">
            <div class="block-conten" align="center">
                <div class="col-md-10 col-md-offset-1">
                    <form data-action="{{ route('superuser.master.product.product_pack.store', $product->id) }}" data-type="POST" enctype="multipart/form-data" class="f1 ajax" novalidate>
                    @csrf
                		<div class="f1-steps">
                              ...
                              <div class="row">
                                <div class="col">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="js-select2 form-control" id="brand_name"  name="brand_name" style="width:100%;" data-placeholder="Pilih Brand" disabled>
                                          <option value=""></option>
                                  ...
                                  <div class="col">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <select class="js-select2 form-control" id="searah"  name="searah" style="width:100%;" data-placeholder="Pilih Searah" disabled>
                              ...
                              <div class="row">
                                  <div class="col">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <select class="js-select2 form-control" id="category"  name="category" style="width:100%;" data-placeholder="Pilih Kategori" disabled>
