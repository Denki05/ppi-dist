                            ...
                            <div class="container">
                              <div class="row">
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="brand_name"  name="brand_name" data-placeholder="Pilih Merek">
                                      <option value=""></option>
                                      @foreach($merek as $key)
                                      <option value="{{ $key->brand_name }}" @if($product->brand_name == $key->brand_name) selected @endif>{{$key->brand_name}}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                </div>
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="category"  name="category" data-placeholder="Pilih Kategori">
                                      ...
                                      <option value="{{ $cat->id }}" @if($product->category_id == $cat->id) selected @endif>{{ $cat->name }} - {{ $cat->packaging->pack_name }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="brand_reference"  name="brand_reference" data-placeholder="Pilih Brand">
                                      <option value=""></option>
                                      @foreach($brand_references as $key)
                                      <option value="{{ $key->id }}" @if($product->brand_references_id == $key->id) selected @endif>{{$key->name}}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                <div class="form-group">
