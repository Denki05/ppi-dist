...
<div class="block">
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.master.question.store') }}" data-type="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row pt-30">
        <div class="col-md-6">
          <a href="{{ route('superuser.master.question.index') }}">
