{{-- CSS bersama halaman PO step & show (two column layout). Dipakai via @_include di dalam tag <style>. --}}
  ...
  .po-wrap { display: flex; gap: 20px; align-items: flex-start; }
  ...
  .po-main-card .po-main-inner { padding: 0 14px 12px; }
  ...
  .po-tabs-wrap { margin-top: 14px; }
  .po-tabs-wrap .nav-tabs { border-bottom: 0; background: var(--po-bg-soft); border-radius: 12px; padding: 5px; display: inline-flex; flex-wrap: wrap; max-width: 100%; gap: 2px; }
  ...
  .po-panel { border: 1px solid var(--po-line); border-radius: 12px; overflow: hidden; margin-top: 14px; }

  .po-section-label { font-size: 14px; font-weight: 800; text-transform: uppercase; letter-spacing: .05em; color: var(--po-ink); margin: 0 0 6px 2px; }
  .po-inputbar { background: linear-gradient(180deg, #fbfcfe, var(--po-bg-soft)); padding: 8px 10px 2px; border-bottom: 1px solid var(--po-line); }
  .po-inputbar .form-group { margin-bottom: 8px; }
  ...
  .po-edit-mode .field-label { display: block; font-size: 10.5px; font-weight: 600; color: var(--po-muted); margin-bottom: 3px; }
  ...
  .po-panel .table tbody td { border-top: 1px solid #eef1f7; padding: 5px 7px; font-size: 12.5px; vertical-align: middle; }
  .po-panel .table thead th { padding: 6px 7px; }
  ...
  .empty-state td { padding: 18px 8px !important; }
  ...
  .btn-add-tab { border-radius: 8px; box-shadow: 0 3px 10px rgba(40,167,69,.30); white-space: nowrap; }
