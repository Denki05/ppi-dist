          ...
          <div class="container">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo" href="index.php">
                <img src="{{ asset('superuser_assets/plus-admin/assets/images/logo.svg') }}" alt="logo" />
                ...
                <li class="nav-item nav-profile dropdown">
                  <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="nav-profile-text">
                      <p class="text-black font-weight-semibold m-0">{{ $superuser->name ?? 'User' }}</p>
              ...
              <li class="nav-item {{ is_open_route('superuser/master') }}">
                ...
                <div class="submenu">
                  <ul class="submenu-item">
                    <li class="nav-item">
                      <a class="nav-link {{ is_active_route('superuser.master.company.show') }}" href="{{ route('superuser.master.company.show') }}">Company</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link {{ is_active_route('superuser.master.branch_office.index') }}" href="{{ route('superuser.master.branch_office.index') }}">Branch Office</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link {{ is_active_route('superuser.master.warehouse.index') }}" href="{{ route('superuser.master.warehouse.index') }}">Warehouse</a>
                    </li>
                  </ul>
                </div>
              </li>
