...
<!-- Modal Create -->
<div class="modal fade" id="unifraBeli" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <select class="js-select2 form-control js-select2-unifra_beli" id="addInvoice" name="addInvoice" data-placeholder="Pilih Invoice" style="width: 100%;">
                        ...
                        <input type="hidden" name="type_invoice" id="type_invoice" value="1">
                    </div>
                </div>
...
$(document).ready(function() {
  ...
  $(".js-select2-unifra_beli").select2({
      ajax: {
        url: '{{ route('superuser.accounting.invoice_tax.search_invreal_beli') }}',
        dataType: 'json',
        delay: 250,
