...
<nav class="breadcrumb bg-white push">
    ...
    <span class="breadcrumb-item active">Create Non Mitra</span>
</nav>
...
<div class="block">
    <div class="block-content">
        <form class="ajax" data-action="{{ route('superuser.accounting.finance_simulation.store_non_mitra') }}" data-type="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="block">
