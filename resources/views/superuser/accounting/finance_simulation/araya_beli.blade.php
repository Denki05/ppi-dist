...
<div>
<h2 style="text-align: center; margin: 0; padding: 15; margin-bottom: 5px;"><u>INVOICE BELI UV ARAYA</u></h2>
        ...
        <table class="table borderless info" style="width: 100%;">
          <tbody>
            <tr>
              ...
              <td style="width: 63% !important;">{{ $result->customer->name }} {{ $result->customer->text_kota }}</td>
            </tr>
            <tr>
              <td>Alamat</td>
              <td>:</td>
...
<table class="table-data">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $row->qty }}</td>
            <td class="text-right">{{ number_format($row->amount_cashback_idr / $row->qty, 2) }}</td>
            <td class="text-right">{{ number_format($row->amount_cashback_idr, 2) }}</td>
        </tr>
        @endforeach
    </tbody>
    <tfoot>
            ...
            <tr>
                    ...
                    <td class="text-right" style="font-size: 14px; "><strong>{{ number_format($doDetails->slice($page * $limit, $limit)->sum('amount_cashback_idr'), 2) }}</strong></td>
            </tr>
    </tfoot>
</table>
</div>
