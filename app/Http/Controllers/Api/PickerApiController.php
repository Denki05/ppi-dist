    ...
    public function getTaskDetail($id)
    {
        ...
        return response()->json([
            ...
            'data'    => [
                ...
                'contact_person'  => optional($result->member)->contact_person, // sesuaikan nama kolom aslinya
                'city'            => optional($result->member)->text_kota,
                'address'         => optional($result->member)->address,
                'kelurahan'       => optional($result->member)->kelurahan,     // sesuaikan nama kolom
                'kecamatan'       => optional($result->member)->kecamatan,     // sesuaikan nama kolom
                'prov'            => optional($result->member)->prov,          // sesuaikan nama kolom
                'phone'           => optional($result->member)->phone,         // <-- INI YANG DIBUTUHKAN
                'items'           => $items,
            ],
        ], 200);
    }
