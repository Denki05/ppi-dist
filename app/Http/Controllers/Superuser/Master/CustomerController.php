...
use App\Entities\Master\Employee;
        ...
        if ($request->ajax()) {
            ...
            if ($validator->passes()) {
                ...
                try{
                    ...
                    if ( strtolower($name) == strtolower($input_name) && $kota == $input_kota && $category == $input_category){
                        $response['notification'] = [
                            'alert' => 'block',
                            'type' => 'alert-danger',
                            'header' => 'Error',
                        ...
                        if ($customer->save()) {
                            ...
                            $other_address->officer = null;
                            $other_address->account_representative = null;
                            $other_address->setting_income_target = 0;
