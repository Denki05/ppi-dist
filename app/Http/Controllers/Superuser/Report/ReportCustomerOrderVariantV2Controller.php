...
class ReportCustomerOrderVariantV2Controller extends Controller
{
    public function __construct(){
        $this->view = "superuser.report.customer_order_variant_v2.";
        $this->route = "superuser.report.customer_order_variant_v2";
