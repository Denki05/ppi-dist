...
class ReportForecastSupplierController extends Controller
{
    ...
    public function printReport(Request $request)
    {
        ...
        $creport->RecordSelectionFormula = "ISNULL({Command.tanggal_so})OR{Command.tanggal_so}>=#$start#AND{Command.tanggal_so}<=#$end#AND{Command.nama_vendor}='$vendor'";
