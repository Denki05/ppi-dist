...
class PurchaseOrderDetailSPKController extends Controller
{
    public function __construct(){
        $this->view = "superuser.gudang.purchase_order_detail_spk.";
        $this->route = "superuser.gudang.purchase_order_spk.detail";
        ...
        if ($request->ajax()) {
            ...
            if ($validator->passes()) {
                ...
                if ($purchase_order_detail->save()) {
                    ...
                    $response['redirect_to'] = route('superuser.gudang.purchase_order_spk.step', $id);
