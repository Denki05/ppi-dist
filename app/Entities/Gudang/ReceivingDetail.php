...
{
    protected $fillable = [
        'receiving_id', 'po_id', 'po_detail_id', 'product_packaging_id', 'quantity', 'total_quantity_ri', 'total_quantity_colly', 'delivery_cost', 'no_batch' ,'description', 'total_ri_idr', 'grand_total'
    ];
