...
class CustomerOtherAddress extends Model
{
    ...
    protected $fillable = [
        'customer_id', 'member_default', 'am', 'ams', 'pic', 'officer', 'account_representative', 'account_representative_optional_1', 'account_representative_optional_2', 'name', 'contact_person', 'npwp', 'ktp', 'phone', 'address',
